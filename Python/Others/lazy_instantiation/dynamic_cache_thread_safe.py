...
print("\nWARNING: Any class uses the decorator @dependent_cached_property_thread_safe, MUST inherit CachedPropertyDependencyThreadSafeMixin")
print("Make sure to do that, the dependency functionality won't work if you don't.\n")

print("WARNING: Use @thread_safe decorator under the @dependent_cached_property_thread_safe decorator")
print("If don't, inside of the property function won't be threadsafe")
print("Do it EXACTLY like the how_to_use file. (As the decorator orders in the example)\n")
