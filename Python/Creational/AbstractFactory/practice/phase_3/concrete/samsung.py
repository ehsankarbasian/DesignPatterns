from abstract import AbstractHomeApplianceFactory, AbstractPhoneFactory, AbstractMediaFactory
...
# Concrete Factory
class SamaungFactory(AbstractHomeApplianceFactory, AbstractPhoneFactory, AbstractMediaFactory):
