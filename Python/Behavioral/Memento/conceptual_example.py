...
# code from: https://refactoring.guru/design-patterns/memento/python/example

class Originator:
    """
    Holds some important state that may change over time.
    Also defines a method for saving the state inside a memento,
    And has another method for restoring the state from it.
    """
