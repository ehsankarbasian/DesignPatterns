...
# Code from: "https://refactoring.guru/design-patterns/chain-of-responsibility/python/example"
...
class AbstractHandler(HandlerInterface):
    ...
    def set_next(self, handler: HandlerInterface) -> HandlerInterface:
        ...
        # Returning a handler from here will let us link handlers like a chain:
...
def client_code(handler: HandlerInterface) -> None:
    """
