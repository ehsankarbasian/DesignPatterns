...
# code from: https://refactoring.guru/design-patterns/mediator/python/example
...
class _BaseComponent:
    """
    The basic functionality of storing a mediator's instance inside component objects.
    """
...
class Component1(_BaseComponent):
    def do_a(self) -> None:
...
class Component2(_BaseComponent):
    def do_c(self) -> None:
