...
# Code from: "https://refactoring.guru/design-patterns/flyweight/python/example"

class Flyweight:
    """
    The Flyweight stores a common portion of the state that belongs to multiple
    ...
    def operation(self, unique_state: str) -> None:
        ...
        print(f"Flyweight: Displaying shared ({shared}) and unique ({unique}) state.", end="")
...
class FlyweightFactory:
    ...
    When the client requests a flyweight, the factory either returns
    ...
    def _get_key(self, state: Dict) -> str:
